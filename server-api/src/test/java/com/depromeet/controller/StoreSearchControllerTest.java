...
public class StoreSearchControllerTest extends RestDocsTestSupport {
    ...
    void search() throws Exception {
        ...
        given(storeSearchService.searchStoreList(any(),eq(query),eq(x),eq(y), eq(java.util.Optional.ofNullable(storePage)), eq(java.util.Optional.ofNullable(cafePage)))).willReturn(storeSearchResponse);
                ...
                .andDo(
                        restDocs.document(
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("data.storeSearchResult[].latitude").type(JsonFieldType.NUMBER).description("음식점 위도"),
                                        fieldWithPath("data.storeSearchResult[].longitude").type(JsonFieldType.NUMBER).description("음식점 경도"),
                                        fieldWithPath("data.storeIsEnd").type(JsonFieldType.BOOLEAN).description("음식점 검색 결과 마지막 페이지 여부"),
