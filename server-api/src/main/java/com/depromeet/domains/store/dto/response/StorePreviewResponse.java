...
public class StorePreviewResponse {
    ...
    public static StorePreviewResponse of(Long storeId, String categoryName, String storeName, String address, Float starRating, Long reviewCount, List<String> reviewImageUrls, Long userId, Long revisitedCount, Long totalRevisitedCount) {
